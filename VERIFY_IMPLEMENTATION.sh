...
check_file "docs/CALL_SHEET_PDF_EXPORT_UPGRADE_IMPLEMENTED.md" "Implementation Guide"
check_file "docs/DEPLOYMENT_GUIDE.md" "Deployment Guide"
check_file "docs/QUICK_REFERENCE.md" "Quick Reference"
check_file "docs/IMPLEMENTATION_SUMMARY.md" "Summary Document"
...
check_content "docs/CALL_SHEET_PDF_EXPORT_UPGRADE_IMPLEMENTED.md" "Phase 1" "Implementation Guide"
check_content "docs/DEPLOYMENT_GUIDE.md" "migration" "Deployment Guide"
check_content "docs/QUICK_REFERENCE.md" "Status.*Complete" "Quick Reference"
check_content "docs/IMPLEMENTATION_SUMMARY.md" "Status.*COMPLETE" "Summary Document"
...
if [ $FAILED -eq 0 ]; then
  ...
  echo ""
  echo "Next steps:"
  echo "  1. Review docs/DEPLOYMENT_GUIDE.md for deployment instructions"
