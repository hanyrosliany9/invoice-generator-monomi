...
export const InvoiceStatusEditor: React.FC<InvoiceStatusEditorProps> = ({
  ...
  const availableTransitions = invoiceService.getAvailableStatusTransitions(invoice.status);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      message.success(`Status invoice ${invoice.invoiceNumber} berhasil diubah ke ${invoiceService.getStatusLabel(selectedStatus)}`);
