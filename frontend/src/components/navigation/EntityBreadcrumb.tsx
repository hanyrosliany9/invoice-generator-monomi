            ...
            <>
              ...
              >
                <Button
                  ...
                  className='p-0 h-auto text-blue-600 hover:text-blue-800'
                  aria-label={t(
                    'breadcrumb.viewParentEntities',
                    'View parent entities'
                  )}
                  title={t(
                    'breadcrumb.viewParentEntities',
                    'View parent entities'
          ...
          <div className='flex items-center space-x-2 flex-1 overflow-hidden'>
            ...
            {lastItem?.status && (
              <Badge
                ...
                text={t(
                  `status.${lastItem.status.toLowerCase()}`,
                  lastItem.status
                )}
              />
            )}
            ...
            title: (
              <Space className='max-w-xs'>
                ...
                {index < breadcrumbItems.length - 1 ? (
                  ...
                  <Text strong className='truncate max-w-32 lg:max-w-none'>
                    {item.name}
                  </Text>
                )}
                {item.status && (
