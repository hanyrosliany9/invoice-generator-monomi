...
export const ReportsPage: React.FC = () => {
  ...
  const { data: revenueData, isLoading: revenueLoading } = useQuery({
    ...
    queryFn: () => reportsService.getRevenueAnalytics({
      period: reportType,
  ...
  const isLoading = revenueLoading || clientLoading || projectLoading || paymentLoading
  ...
  const generateTopClientsData = () => {
    ...
    return safeArray(clientData.topClients).map((item, index) => ({
      ...
      percentage: (safeDivision(safeNumber(item?.revenue), safeNumber(revenueData?.totalRevenue)) * 100).toFixed(1)
    }))
  }
    ...
    },
    {
      ...
      render: (value: string) => (
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <Progress percent={safeNumber(value)} size="small" style={{ width: '60px' }} />
          <Text>{value}%</Text>
        </div>
      ),
    },
    ...
    <div style={{ padding: '16px 24px' }}>
      <div style={{ 
        ...
        <div>
          <Title level={2} style={{ margin: 0, color: '#1e293b' }}>
            <BarChartOutlined style={{ marginRight: '12px', color: '#1e40af' }} />
            Laporan Keuangan
          </Title>
      ...
      <Row gutter={[24, 24]} style={{ marginBottom: '32px' }}>
        <Col xs={24} sm={12} lg={6}>
          ...
          >
            <Statistic
              title={<span style={{ color: 'rgba(255,255,255,0.8)' }}>{t('reports.totalRevenue')}</span>}
        ...
        <Col xs={24} sm={12} lg={6}>
          ...
          >
            <Statistic
              title={<span style={{ color: 'rgba(255,255,255,0.8)' }}>{t('reports.paidInvoices')}</span>}
        ...
        <Col xs={24} sm={12} lg={6}>
          ...
          >
            <Statistic
              title={<span style={{ color: 'rgba(255,255,255,0.8)' }}>{t('dashboard.totalClients')}</span>}
        ...
        <Col xs={24} sm={12} lg={6}>
          ...
          >
            <Statistic
              title={<span style={{ color: 'rgba(255,255,255,0.8)' }}>{t('dashboard.totalProjects')}</span>}
      ...
      <Row gutter={[24, 24]} style={{ marginBottom: '32px' }}>
          ...
          <Card
            title={
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <LineChartOutlined style={{ marginRight: '8px', color: '#1e40af' }} />
                <span style={{ color: '#1e293b', fontWeight: 600 }}>Analisis Pendapatan</span>
              </div>
            }
            extra={
              <Select
        ...
        <Col xs={24} lg={8}>
          <Card
            title={
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <PieChartOutlined style={{ marginRight: '8px', color: '#1e40af' }} />
                <span style={{ color: '#1e293b', fontWeight: 600 }}>Analisis Pembayaran</span>
              </div>
            }
            style={{ 
              borderRadius: '16px', 
      ...
      <Row gutter={[24, 24]} style={{ marginBottom: '32px' }}>
        <Col span={24}>
          <Card
            title={
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <BarChartOutlined style={{ marginRight: '8px', color: '#1e40af' }} />
                <span style={{ color: '#1e293b', fontWeight: 600 }}>Tren Pembayaran Bulanan</span>
              </div>
            }
            style={{ 
              borderRadius: '16px', 
      ...
      <Row gutter={[24, 24]}>
        <Col xs={24} lg={12}>
          <Card
            title={
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <UserOutlined style={{ marginRight: '8px', color: '#1e40af' }} />
                <span style={{ color: '#1e293b', fontWeight: 600 }}>Analisis Klien Teratas</span>
              </div>
            }
            style={{ 
              borderRadius: '16px', 
        ...
        <Col xs={24} lg={12}>
          <Card
            title={
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <ProjectOutlined style={{ marginRight: '8px', color: '#1e40af' }} />
                <span style={{ color: '#1e293b', fontWeight: 600 }}>Analisis Proyek Teratas</span>
              </div>
            }
            style={{ 
              borderRadius: '16px', 
