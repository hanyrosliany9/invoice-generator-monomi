...
export class MetricsController {
  ...
  async getPrometheusMetrics() {
    ...
    const performanceMetrics =
      await this.metricsService.getPerformanceMetrics();
    ...
    prometheusMetrics +=
      "# HELP database_query_duration_milliseconds Database query duration\n";
    ...
    prometheusMetrics +=
      "# HELP business_entities_total Total number of business entities\n";
    ...
    prometheusMetrics +=
      "# HELP revenue_total_idr Total revenue in Indonesian Rupiah\n";
