...
export class NotificationsController {
  ...
  async sendNotification(@Body() sendNotificationDto: SendNotificationDto): Promise<ApiResponseDto<null>> {
    try {
  ...
  async testNotification(@Query('email') email?: string): Promise<ApiResponseDto<null>> {
    try {
      ...
      return ApiResponseDto.success(null, 'Test notification sent successfully');
    } catch (error) {
  ...
  async getNotificationTemplates(): Promise<ApiResponseDto<any>> {
    try {
      ...
      return ApiResponseDto.success(templates, 'Notification templates retrieved successfully');
    } catch (error) {
      return ApiResponseDto.error('Failed to retrieve notification templates', null);
    }
  }
}