...
export class ReportsController {
  ...
  async exportSalesAndReceivables(
    ...
    try {
      ...
      const buffer =
        await this.excelExportService.generateSalesAndReceivablesReport(
          filters,
        );
  ...
  async exportExcel(
    ...
    try {
      ...
      if (
        body.reportType === "sales-receivables" ||
  ...
  async exportSalesAndReceivablesPdf(
    ...
    try {
      ...
      const buffer =
        await this.pdfExportService.generateSalesAndReceivablesReport(filters);
  ...
  async exportPdf(
    ...
    try {
      ...
      if (
        ...
        const buffer =
          await this.pdfExportService.generateSalesAndReceivablesReport(
            filters,
            pdfOptions,
          );
