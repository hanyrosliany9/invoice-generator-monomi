...
export class ExpenseQueryDto {
  @ApiPropertyOptional({
    description: "Search query (description, vendor, NSFP, account code)",
  })
  @IsOptional()
  @IsString()
  search?: string;
  ...
  @ApiPropertyOptional({
    description: "Filter by expense class",
    enum: ExpenseClass,
  })
  @IsOptional()
  @IsEnum(ExpenseClass)
  ...
  @ApiPropertyOptional({
    description: "Filter by PPN category",
    enum: PPNCategory,
  })
  @IsOptional()
  @IsEnum(PPNCategory)
  ...
  @ApiPropertyOptional({
    description: "Filter by account code (PSAK)",
    example: "6-2050",
  })
  @IsOptional()
  @IsString()
