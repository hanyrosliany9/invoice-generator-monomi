...
export class XssMetricsDto {
  ...
  @ApiProperty({
    example: 156,
    description: "Number of XSS threats blocked in last 24h",
  })
...
export class MateraiMetricsDto {
  @ApiProperty({
    example: 94,
    description: "Materai compliance rate percentage",
  })
  complianceRate: number;

  @ApiProperty({
    example: 1284,
    description: "Total materai validations performed",
  })
...
export class PrivacyMetricsDto {
  ...
  @ApiProperty({
    example: 91,
    description: "Indonesian law compliance score (UU 27/2022)",
  })
...
export class ComplianceAlertDto {
  ...
  @ApiProperty({
    enum: ["security", "privacy", "materai", "business"],
    example: "materai",
  })
  ...
  @ApiProperty({
    example: "15 transaksi memerlukan validasi materai dalam 24 jam terakhir",
  })
  description: string;
  ...
  @ApiProperty({
    example: true,
    description: "Whether this is specific to Indonesian regulations",
  })
