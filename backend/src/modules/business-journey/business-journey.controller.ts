...
export class BusinessJourneyController {
  constructor(
    private readonly businessJourneyService: BusinessJourneyService,
  ) {}
  ...
  @ApiOperation({
    ...
    description:
      "Creates a new business journey event with Indonesian compliance validation",
  })
  @ApiResponse({
    status: 201,
  ...
  async createEvent(
    ...
    return ApiResponseDto.success(
      event,
      "Business journey event created successfully",
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      "Retrieves the complete business journey timeline for a specific client with filtering and pagination",
  })
  @ApiParam({
    name: "clientId",
  ...
  async getClientTimeline(
    ...
    return ApiResponseDto.success(
      timeline,
      "Business journey timeline retrieved successfully",
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      "Retrieves detailed information about a specific business journey event",
  })
  @ApiParam({
    name: "eventId",
  ...
  @ApiOperation({
    ...
    description:
      "Updates an existing business journey event with Indonesian compliance validation",
  })
  @ApiParam({
    name: "eventId",
    description: "Business journey event ID",
  ...
  async updateEvent(
    ...
    return ApiResponseDto.success(
      event,
      "Business journey event updated successfully",
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      "Deletes an existing business journey event. This action cannot be undone.",
  })
  @ApiParam({
    name: "eventId",
    description: "Business journey event ID",
  ...
  @ApiOperation({
    ...
    description:
      "Automatically creates a business journey event based on entity changes (internal API)",
  })
  @ApiResponse({
    status: 201,
  ...
  async autoCreateEvent(
    ...
    return ApiResponseDto.success(
      event,
      event
        ? "Business journey event auto-created successfully"
        : "No event created",
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      "Retrieves comprehensive business analytics and KPI summary for a client",
  })
  @ApiParam({
    name: "clientId",
    description: "Client ID",
  ...
  async getAnalyticsSummary(
    ...
    return ApiResponseDto.success(
      analytics,
      "Business analytics summary retrieved successfully",
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      "Retrieves detailed materai compliance report for Indonesian regulations",
  })
  @ApiParam({
    name: "clientId",
    description: "Client ID",
  ...
  async getMateraiComplianceReport(
    ...
    const complianceReport = {
      ...
      materaiCompliance: timeline.materaiCompliance,
      recommendations: this.generateMateraiRecommendations(
        timeline.materaiCompliance,
      ),
    ...
    return ApiResponseDto.success(
      complianceReport,
      "Materai compliance report retrieved successfully",
    );
  }
  ...
  private generateMateraiRecommendations(compliance: any): string[] {
    ...
    if (compliance.compliancePercentage < 100) {
      recommendations.push(
        "Terdapat invoice yang memerlukan materai. Segera tempelkan materai pada dokumen fisik.",
      );
    }

    if (compliance.pendingAmount > 0) {
      recommendations.push(
        `Total materai yang diperlukan: Rp ${compliance.pendingAmount.toLocaleString("id-ID")}`,
      );
    }

    if (compliance.compliancePercentage < 50) {
      recommendations.push(
        "Tingkat kepatuhan materai rendah. Pertimbangkan untuk mengatur sistem reminder otomatis.",
      );
    }
