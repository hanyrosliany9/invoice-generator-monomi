import { Controller, UseGuards, Put, Post, Body, Param, Req } from '@nestjs/common';
...
export class MetadataController {
  ...
  async updateStarRating(
    ...
    return this.metadataService.updateStarRating(assetId, updateDto.starRating, req.user.id);
  }

  @Post('bulk/star-rating')
  @ApiOperation({ summary: 'Bulk update star rating for multiple assets' })
  async bulkUpdateStarRating(@Body() bulkDto: BulkUpdateStarRatingDto, @Req() req: AuthenticatedRequest) {
  ...
  async bulkUpdateMetadata(
    ...
    return this.metadataService.bulkUpdateMetadata(body.assetIds, body.metadata);
  }
}
