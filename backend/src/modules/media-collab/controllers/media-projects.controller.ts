...
export class MediaProjectsController {
  ...
  create(@Request() req: AuthenticatedRequest, @Body() createDto: CreateMediaProjectDto) {
  ...
  @ApiResponse({ status: 403, description: 'Only owner can enable public sharing' })
  @ApiResponse({ status: 404, description: 'Project not found' })
  ...
  @ApiResponse({ status: 403, description: 'Only owner can disable public sharing' })
  @ApiResponse({ status: 404, description: 'Project not found' })
