...
export class ComparisonController {
  ...
  @ApiResponse({ status: 400, description: 'Invalid number of assets or mixed media types' })
  ...
  @ApiResponse({ status: 200, description: 'Version comparison data returned successfully' })
