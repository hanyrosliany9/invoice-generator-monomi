...
import { IsString, IsBoolean, IsNumber, IsArray, IsOptional, IsEnum, IsObject, Min, Max, IsDate } from 'class-validator';
...
export class CreateFeatureFlagDto {
  ...
  @ApiPropertyOptional({ description: 'Whether the flag is enabled by default', default: false })
  @IsBoolean()
  @IsOptional()
  enabled?: boolean = false;

  @ApiPropertyOptional({ description: 'Initial rollout percentage', minimum: 0, maximum: 100, default: 0 })
  @IsNumber()
  @Min(0)
  @Max(100)
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: 'Target Indonesian regions', type: [String] })
  @IsArray()
  @IsString({ each: true })
  @IsOptional()
  targetRegions?: string[] = [];

  @ApiPropertyOptional({ description: 'Target business sizes', enum: BusinessSize, isArray: true })
  @IsArray()
  @IsEnum(BusinessSize, { each: true })
  @IsOptional()
  targetBusinessSizes?: BusinessSize[] = [];

  @ApiPropertyOptional({ description: 'Feature flag dependencies', type: [String] })
  @IsArray()
  @IsString({ each: true })
  @IsOptional()
  dependencies?: string[] = [];

  @ApiPropertyOptional({ description: 'Whether kill switch is enabled', default: true })
  @IsBoolean()
  @IsOptional()
...
export class RolloutConfigDto {
  ...
  @ApiPropertyOptional({ description: 'Rollout duration in minutes (for gradual rollout)', minimum: 1 })
  @IsNumber()
  @Min(1)
  @IsOptional()
  duration?: number;

  @ApiPropertyOptional({ description: 'Canary rollout percentage', minimum: 1, maximum: 50 })
  @IsNumber()
  @Min(1)
  @Max(50)
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: 'Health check endpoints', type: [String] })
  @IsArray()
  @IsString({ each: true })
  @IsOptional()
  healthChecks?: string[];

  @ApiPropertyOptional({ description: 'Success rate threshold (0-1)', minimum: 0, maximum: 1 })
  @IsNumber()
  @Min(0)
  @Max(1)
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: 'Error rate threshold (0-1)', minimum: 0, maximum: 1 })
  @IsNumber()
  @Min(0)
  @Max(1)
  @IsOptional()
...
export class FeatureFlagQueryDto {
  @ApiPropertyOptional({ description: 'Specific flag IDs to retrieve', type: [String] })
  @IsArray()
  @IsString({ each: true })
  @IsOptional()
  flagIds?: string[];
  ...
  @ApiPropertyOptional({ description: 'Filter by business size', enum: BusinessSize })
  @IsEnum(BusinessSize)
  @IsOptional()
...
export class SafetyCheckDto {
  ...
  @ApiPropertyOptional({ description: 'Indonesian business context checks', type: 'object' })
  @IsObject()
  @IsOptional()
...
export class FeatureFlagHealthDto {
  ...
  @ApiPropertyOptional({ description: 'Health recommendations', type: [String] })
  @IsArray()
  @IsString({ each: true })
  @IsOptional()
  recommendations?: string[];
...
export class IndonesianValidationDto {
  ...
  @ApiPropertyOptional({ description: 'Regional compliance details', type: 'object' })
  @IsObject()
  @IsOptional()
  regionalCompliance?: {
    jakarta: boolean;
  ...
  @ApiPropertyOptional({ description: 'Business etiquette validation', type: 'object' })
  @IsObject()
  @IsOptional()
  businessEtiquette?: {
...
export class FeatureFlagTestDto {
  @ApiPropertyOptional({ description: 'Test users for feature flag validation', type: [String] })
  @IsArray()
  @IsString({ each: true })
  @IsOptional()
  testUsers?: string[];

  @ApiPropertyOptional({ description: 'Test regions for feature flag validation', type: [String] })
  @IsArray()
  @IsString({ each: true })
  @IsOptional()
  testRegions?: string[];

  @ApiPropertyOptional({ description: 'Run in dry-run mode without actual changes' })
  @IsBoolean()
  @IsOptional()
  dryRun?: boolean = true;

  @ApiPropertyOptional({ description: 'Include Indonesian business context validation' })
  @IsBoolean()
  @IsOptional()
  includeIndonesianValidation?: boolean = true;

  @ApiPropertyOptional({ description: 'Test specific business sizes', enum: BusinessSize, isArray: true })
  @IsArray()
  @IsEnum(BusinessSize, { each: true })
  @IsOptional()
...
export class FeatureFlagUserContextDto {
  ...
  @ApiPropertyOptional({ description: 'Indonesian business context', type: 'object' })
  @IsObject()
  @IsOptional()
  indonesianContext?: {
...
export class RolloutUpdateDto {
  @ApiProperty({ description: 'New rollout percentage', minimum: 0, maximum: 100 })
  @IsNumber()
  @Min(0)
  @Max(100)
  percentage: number;
  ...
  @ApiPropertyOptional({ description: 'Schedule the update (future timestamp)' })
  @Type(() => Date)
  @IsDate()
  @IsOptional()
  scheduledFor?: Date;
